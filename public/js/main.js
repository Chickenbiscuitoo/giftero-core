...
/***/ "./src/js/components/ColumnsSwiper.js":
/*!********************************************!*\
  !*** ./src/js/components/ColumnsSwiper.js ***!
  \********************************************/
...
var columnsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".gf-columns-swiper", {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_Clickbox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/Clickbox */ "./src/js/utils/Clickbox.js");
/* harmony import */ var _utils_Clickbox__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_utils_Clickbox__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_Modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/Modal */ "./src/js/utils/Modal.js");
/* harmony import */ var _utils_Modal__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_utils_Modal__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils_SwiperInit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/SwiperInit */ "./src/js/utils/SwiperInit.js");
/* harmony import */ var _utils_SwiperInit__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_utils_SwiperInit__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_ColumnsSwiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/ColumnsSwiper */ "./src/js/components/ColumnsSwiper.js");
// utils
...
var clickboxes = document.querySelectorAll(".clickbox,.clickboxed");
var anchors = document.querySelectorAll(".clickbox a,.clickboxed a");

// attach click event listener to each clickbox element
clickboxes === null || clickboxes === void 0 || clickboxes.forEach(function (clickbox) {
  clickbox === null || clickbox === void 0 || clickbox.addEventListener("click", function () {
...
anchors === null || anchors === void 0 ? void 0 : anchors.forEach(function (anchor) {
  anchor === null || anchor === void 0 || anchor.addEventListener("click", function (e) {
    e.preventDefault();
  });
});
...
if ((modalOpeners === null || modalOpeners === void 0 ? void 0 : modalOpeners.length) > 0 && (modals === null || modals === void 0 ? void 0 : modals.length) > 0) {
  modalOpeners.forEach(function (modalOpener) {
    var _Array$from;
    // get modal-opener modal id
    var modalOpenerClass = (_Array$from = Array.from(modalOpener.classList)) === null || _Array$from === void 0 ? void 0 : _Array$from.find(function (className) {
      return className.startsWith("modal-opener-");
    });
    var modalId = modalOpenerClass === null || modalOpenerClass === void 0 ? void 0 : modalOpenerClass.split("-")[2];
    var modal = Array.from(modals).find(function (modal) {
      return (modal === null || modal === void 0 ? void 0 : modal.id) === "modal-".concat(modalId);
    });
    if (modal) {
      // close
      var modalCloseButton = modal.querySelector(".modal_closer");
      if (modalCloseButton) {
...
var swiperSection = document.querySelectorAll(".swiper-section");
swiperSection === null || swiperSection === void 0 ? void 0 : swiperSection.forEach(function (section) {
  // swiper
  var swiper = section.querySelector(".l-section-h");
  swiper === null || swiper === void 0 || swiper.classList.add("swiper");

  // wrapper
  var swiperWrapper = swiper === null || swiper === void 0 ? void 0 : swiper.querySelector(".l-section-h > .g-cols");
  swiperWrapper === null || swiperWrapper === void 0 || swiperWrapper.classList.add("swiper-wrapper");

  // slides
  var swiperSlides = swiperWrapper === null || swiperWrapper === void 0 ? void 0 : swiperWrapper.querySelectorAll(".l-section-h > .g-cols > .vc_column_container");
  swiperSlides === null || swiperSlides === void 0 || swiperSlides.forEach(function (slide) {
    slide === null || slide === void 0 || slide.classList.add("swiper-slide");
  });

  // scrollbar (data-scrollbar)
  var hasScrollbar = section.getAttribute("data-scrollbar");
  if (hasScrollbar) {
    var scrollbar = document.createElement("div");
    scrollbar.classList.add("swiper-scrollbar");
    swiper === null || swiper === void 0 || swiper.appendChild(scrollbar);
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcore_webstarter"] = self["webpackChunkcore_webstarter"] || [];
